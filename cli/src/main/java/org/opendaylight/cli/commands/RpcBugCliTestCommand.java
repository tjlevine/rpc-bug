 ...
 */
package org.opendaylight.cli.commands;
...
public class RpcBugCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(RpcBugCliTestCommand.class);
    protected final RpcBugCliCommands service;

    public RpcBugCliTestCommand(final RpcBugCliCommands service) {
